...
- Download the tongue segmentation model (`tonguesam.pth`) from the following link: [Download here]([https://pan.baidu.com/s/1zG0jpYshlBs3lcdy4F37dQ?pwd=xtfg](https://drive.google.com/drive/folders/1VfsYQrWYqJkDCaKgNZb22_evbMona_fG?usp=drive_link) (Place `tonguesam.pth` in the `./pretrained_model/` folder).
